...
import com.seuchild.smallseedling.personalass.MyViewHolderAssN;


public class ItemRemoveRecyclerViewN extends RecyclerView {
    ...
    public ItemRemoveRecyclerViewN(Context context) {
        this(context, null);
    }

    public ItemRemoveRecyclerViewN(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemRemoveRecyclerViewN(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    MyViewHolderAssN viewHolder = (MyViewHolderAssN) getChildViewHolder(view);

                    mItemLayout = viewHolder.layout;
                    mPosition = viewHolder.getAdapterPosition();

                    mDelete = (TextView) mItemLayout.findViewById(R.id.fragment_not_finish);
