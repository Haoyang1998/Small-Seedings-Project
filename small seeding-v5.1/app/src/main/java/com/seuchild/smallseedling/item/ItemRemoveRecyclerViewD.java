...
import com.seuchild.smallseedling.personalass.MyViewHolderAssD;

public class ItemRemoveRecyclerViewD extends RecyclerView {
    ...
    public ItemRemoveRecyclerViewD(Context context) {
        this(context, null);
    }

    public ItemRemoveRecyclerViewD(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemRemoveRecyclerViewD(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    MyViewHolderAssD viewHolder = (MyViewHolderAssD) getChildViewHolder(view);

                    mItemLayout = viewHolder.layout;
                    mPosition = viewHolder.getAdapterPosition();

                    mDelete = (TextView) mItemLayout.findViewById(R.id.fragment_done_delete);
            ...
            case MotionEvent.ACTION_UP:
                if (!isItemMoving && !isDragging && mListener != null) {
                    mListener.ItemClick(mItemLayout, mPosition);
                }
                isItemMoving = false;
