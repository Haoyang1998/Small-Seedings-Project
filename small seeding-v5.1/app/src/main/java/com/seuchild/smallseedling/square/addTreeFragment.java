...
public class addTreeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mContext = getContext();
        view = inflater.inflate(R.layout.fragment_addtree, null);
        mbutton_addphotos = view.findViewById(R.id.bu_addt_photos);
        miv_addpresent = view.findViewById(R.id.addt_iv_present);
        meditText = view.findViewById(R.id.et_addt);
            ...
            public void onClick(View v) {
                ...
                if(str.equals("")){
                    ...
                    Thread post=new Thread(new Runnable() {
                        @Override
                        public void run() {
                            String url = "http://"+ SmallSeedlingApplication.server_ip+":"+SmallSeedlingApplication.server_port+"/tree";


                            FormBody formBody=new FormBody.Builder().add("m_content",str).
                                    add("m_url",iamge_url).build();
    ...
    public static addTreeFragment newInstance(){return new addTreeFragment();}
